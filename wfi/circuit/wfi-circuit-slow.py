...
def main(args):
    ...
    with tf.Graph ().as_default ():
        ...
        with tf.name_scope ("DataPreprocess"):
            ...
            df_data = np.load (args.data_root+'/datasets/df_slow.npz')
        ...
        writer = tf.summary.FileWriter (_next_logdir ("tensorboard/wfi_slow_circuit"))
...
if __name__ == "__main__":
    ...
    parser.add_argument ('--train_epochs', required=False, default=30)
