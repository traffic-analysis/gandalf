...
def main(args):
    ...
    with tf.Graph().as_default():
        ...
        with tf.name_scope("DataPreprocess"):
            ...
            awf_data = np.load (HOME+'/datasets/gdlf25_ow_old_ipd.npz',
                                allow_pickle=True)
        ...
        with tf.name_scope("InputPipeline"):
            ...
            for i in range(args.num_classes):
                ...
                test_x_data.append(X[y == i][args.num_labeled_examples:args.num_labeled_examples + 96*5])
        ...
        writer = tf.summary.FileWriter(_next_logdir("tensorboard/wfs10_cw"))
