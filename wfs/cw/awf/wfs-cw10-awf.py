    ...
    with tf.Graph().as_default():
        ...
        with tf.name_scope("InputPipeline"):
            ...
            for i in range(args.num_classes):
                print(i)
                train_x_labeled.append(X[y == i][:args.num_labeled_examples])  # 30ins per website for pfp, 100ins per website for DF
                train_y_labeled.append(y[y == i][:args.num_labeled_examples])
                test_x_data.append(X[y == i][args.num_labeled_examples:args.num_labeled_examples + 96*5])  # 30ins per website for pfp, 100ins per website for DF
                test_y_data.append(y[y == i][args.num_labeled_examples:args.num_labeled_examples + 96*5])
        ...
        writer = tf.summary.FileWriter(_next_logdir("tensorboard/wfs10_cw_awf"))
...
if __name__ == "__main__":
    ...
    parser.add_argument ('--train_epochs', required=False, default=3)
    ...
    parser.add_argument ('--num_labeled_examples', required=False, default=10)
